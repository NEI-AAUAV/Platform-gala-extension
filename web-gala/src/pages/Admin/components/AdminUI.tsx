...
export function TextInput({ value, onChange, placeholder }: { readonly value: string; readonly onChange: (v: string) => void; readonly placeholder?: string }) {
  return (
    <input
      type="text"
      value={value}
...
export function NumberInput({ value, onChange, min = 0 }: { readonly value: number; readonly onChange: (v: number) => void; readonly min?: number }) {
  return (
    <input
      type="number"
      min={min}
...
export function TextArea({ value, onChange, placeholder }: { readonly value: string; readonly onChange: (v: string) => void; readonly placeholder?: string }) {
  return (
    <textarea
      value={value}
      onChange={(e) => onChange(e.target.value)}
...
export function DateTimeInput({ value, onChange }: { readonly value: string; readonly onChange: (v: string) => void }) {
  return (
    <input
      type="datetime-local"
      value={value}
...
export function Section({ title, children, defaultOpen = false }: { readonly title: string; readonly children: React.ReactNode; readonly defaultOpen?: boolean }) {
...
export function StringListEditor({ items, onChange, placeholder }: { readonly items: string[]; readonly onChange: (v: string[]) => void; readonly placeholder?: string }) {
  return (
