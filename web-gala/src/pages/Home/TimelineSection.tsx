  ...
  return (
    <section id="timeline" className="relative flex flex-col items-center justify-center px-4 py-32 backdrop-blur-md">
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          <span className="font-gala text-sm font-bold uppercase tracking-[0.4em] text-light-gold/60">A Jornada</span>
          <h2 className="mt-4 font-gala text-[3.5rem] font-black text-white sm:text-[4.5rem] tracking-tight">
            {title}
          </h2>
        </motion.div>
            ...
            {phases.map((phase, idx) => (
              ...
              >
                <div className="relative z-10 flex items-center gap-6">
                  <span className={`font-gala text-4xl font-black italic transition-colors duration-500 ${
                    selectedPhase === phase.id ? "text-light-gold" : "text-white/10"
                  }`}>
                    0{idx + 1}
                  </span>
              ...
              <div className="relative aspect-[21/9] w-full overflow-hidden rounded-3xl border border-white/10 shadow-2xl lg:aspect-[16/7]">
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  ...
                  >
                    ...
                    <p className="mt-4 max-w-2xl font-gala text-lg text-white/70 leading-relaxed">
