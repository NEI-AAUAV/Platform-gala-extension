  ...
  return (
    ...
    >
      {photoUrl ? (
        ...
        <div className="bg-white/3 flex h-full w-full items-center justify-center">
...
function DJInfo({ djConfig }: { readonly djConfig: DJConfig }) {
  return (
    ...
    >
      ...
      {djConfig.bio && (
        <p className="text-white/65 font-gala text-lg leading-relaxed">
          {djConfig.bio}
        </p>
      )}
      ...
      {djConfig.spotify_url && (
        <a
          ...
          className="bg-[#1DB954]/8 hover:bg-[#1DB954]/15 group flex w-fit items-center gap-3 rounded-full border border-[#1DB954]/40 px-6 py-3 font-gala text-sm font-bold text-[#1DB954] transition-all hover:border-[#1DB954]/70"
        >
          <svg
            viewBox="0 0 24 24"
