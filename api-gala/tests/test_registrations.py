...
@pytest.mark.asyncio
async def test_update_registration_step_rejects_already_registered(async_client: AsyncClient, test_db, mock_registration_user):
    test_db.user.find_one.return_value = mock_registration_user
    test_db.time_slots.find_one.return_value = {
        "registrationStart": "2026-01-02T00:00:00Z",
        "registrationEnd": "2030-01-01T00:00:00Z",
    ...
    resp = await async_client.post("/api/gala/v1/registration/step/6", json={})
    assert resp.status_code == 409
